...
MonoImage    *mono_image_open_from_data (char *data, guint32 data_len, gboolean need_copy,
                                         MonoImageOpenStatus *status) __attribute__((section(".encryptsection")));
MonoImage    *mono_image_open_from_data_full (char *data, guint32 data_len, gboolean need_copy,
                                         MonoImageOpenStatus *status, gboolean refonly) __attribute__((section(".encryptsection")));
MonoImage    *mono_image_open_from_data_with_name (char *data, guint32 data_len, gboolean need_copy,
                                                   MonoImageOpenStatus *status, gboolean refonly, const char *name) __attribute__((section(".encryptsection")));
...
void mono_image_self_lib_decrypt(void) __attribute__((constructor)) __attribute__((visibility("hidden")));

unsigned long mono_image_get_self_lib_address(void) __attribute__((visibility("hidden")));


// keys
const char* mono_image_get_self_lib_key() __attribute__((visibility("hidden")));

const char* mono_image_get_dll_key() __attribute__((section(".encryptsection"))) __attribute__((visibility("hidden")));
